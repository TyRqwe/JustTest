...
echo "=== Установка PostgreSQL и инструментов для тестирования ==="
sudo apt update
...
# При желании измените масштаб через переменную PGBENCH_SCALE
...
echo "Для нагрузочного тестирования используйте скрипт run_benchmark.sh"
